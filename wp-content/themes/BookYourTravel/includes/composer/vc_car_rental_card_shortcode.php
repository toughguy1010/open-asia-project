<?php
/**
 * BookYourTravel_VC_Car_Rental_Card_Shortcode class
 *
 * @package WordPress
...
class BookYourTravel_VC_Car_Rental_Card_Shortcode extends BookYourTravel_BaseSingleton {
	...
	function vc_frontend_editor_render() {
		wp_enqueue_script( 'vc-car-rental-card', BookYourTravel_Theme_Utils::get_file_uri ('/js/admin/composer/vc_car_rental_card.js'), array('vc-frontend-editor-min-js'), time(), true );
		wp_enqueue_style( 'vc-byt-style-custom', BookYourTravel_Theme_Utils::get_file_uri ('/css/admin/composer_custom.css') );
	}
	...
	function vc_map_init() {
		...
		vc_map(array(
			"name" => __( "Car Rental Card", "bookyourtravel" ),
			"description" => __( "Display a single car rental", "bookyourtravel" ),
			"base" => "byt_car_rental_card",
			"class"	  => "byt_widget",
			'weight'  => 9,	
			...
			"params" => array(
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Car Rental", "bookyourtravel" ),
					"param_name" => "car_rental_id",
					"description" => __( "Type the name of the car rental you want to display", "bookyourtravel" ),
					'settings' => array(
						'multiple' => false,
						'min_length' => 1,
						'groups' => false,
            ...
            "custom_markup" => sprintf("
                ...
                __("Car Rental Card", "bookyourtravel"),
                __("This is a car rental card widget. To access all the features of this block please use the front editor.", "bookyourtravel")
            )
		));
	}
}

$bookyourtravel_vc_car_rental_card_shortcode = BookYourTravel_VC_Car_Rental_Card_Shortcode::get_instance();;
$bookyourtravel_vc_car_rental_card_shortcode->init();