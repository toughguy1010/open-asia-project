<?php
/**
 * BookYourTravel_VC_Tour_Card_Shortcode class
 *
 * @package WordPress
...
class BookYourTravel_VC_Tour_Card_Shortcode extends BookYourTravel_BaseSingleton {
	...
	function vc_frontend_editor_render() {
		wp_enqueue_script( 'vc-tour-card', BookYourTravel_Theme_Utils::get_file_uri ('/js/admin/composer/vc_tour_card.js'), array('vc-frontend-editor-min-js'), time(), true );
		wp_enqueue_style( 'vc-byt-style-custom', BookYourTravel_Theme_Utils::get_file_uri ('/css/admin/composer_custom.css') );
	}
	...
	function vc_map_init() {
		...
		vc_map(array(
			"name" => __( "Tour Card", "bookyourtravel" ),
			"description" => __( "Display a single tour", "bookyourtravel" ),
			"base" => "byt_tour_card",
			"class"	  => "byt_widget",
			'weight'  => 7,	
			...
			"params" => array(
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Tour", "bookyourtravel" ),
					"param_name" => "tour_id",
					"description" => __( "Type the name of the tour you want to display", "bookyourtravel" ),
					'settings' => array(
						'multiple' => false,
						'min_length' => 1,
						'groups' => false,
            ...
            "custom_markup" => sprintf("
                ...
                __("Tour Card", "bookyourtravel"),
                __("This is a tour card widget. To access all the features of this block please use the front editor.", "bookyourtravel")
            )
		));
	}
}

$bookyourtravel_vc_tour_card_shortcode = BookYourTravel_VC_Tour_Card_Shortcode::get_instance();;
$bookyourtravel_vc_tour_card_shortcode->init();