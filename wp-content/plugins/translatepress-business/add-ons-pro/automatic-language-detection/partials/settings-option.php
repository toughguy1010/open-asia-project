<tr> <td><h2><?php esc_html_e( 'Automatic User Language Detection', 'translatepress-multilingual' ); ?></h2> </td></tr><br>

<tr>
    <th scope="row"><b><?php esc_html_e( 'Method of language detection', 'translatepress-multilingual' ); ?></b> </th>
	<td>
...
<tr>
    <th scope="row"><b><?php esc_html_e( 'Pop-up to notify the user of the detected language', 'translatepress-multilingual' ); ?></b> </th>
    <td>
